#!/bin/bash
#
# OrchanixOS Stage 3 build script (GNOME).
...
# Gjs (Precompiled)
tar --no-same-owner --same-permissions -xf gjs-1.74.0-x86_64-precompiled-OrchanixOS-2022.09.tar.xz
cp -a gjs-1.74.0-x86_64-precompiled-OrchanixOS-2022.09/BINARY/* /
ldconfig
rm -rf gjs-1.74.0-x86_64-precompiled-OrchanixOS-2022.09
# gnome-desktop
